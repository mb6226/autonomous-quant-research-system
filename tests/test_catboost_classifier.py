...
def test_catboost_classifier_run():
    # ensure limited resources for local runs
    os.environ.setdefault("OMP_NUM_THREADS", "1")
    os.environ.setdefault("MKL_NUM_THREADS", "1")

    runner = ExperimentRunner()

    # prepare dataset and target as ExperimentRunner would
    market = "BTCUSDT"
    timeframe = "1d"
    ...
    model_impl = runner._get_model_impl("catboost")
